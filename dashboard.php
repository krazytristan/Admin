...
<head>
  ...
  <script src="j7zutixs5yhcdkg11kr8913m7mj0c813d7wgcglaptm2ao4r" referrerpolicy="origin"></script>
...
if($sub[0]=='add')
{
  ...
  include($cat."/".$subcat.".php");
            ...
            echo "<h1 class='text-success text-center'>Admin Dashboard</h1>";
        }
...
<script
    ...
    src='j7zutixs5yhcdkg11kr8913m7mj0c813d7wgcglaptm2ao4r'
